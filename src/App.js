  ...
  render() {
    ...
    return (
      <div>
        ...
        {/* Render logout button only if the user is authenticated */}
        {isAuthenticated && (
            <button onClick={this.handleLogout} style={{ margin: '10px', padding: '10px' }}>
              Logout
            </button>
          )}
  {/* Render Login/Signup toggle */}
  {/* {!isAuthenticated && (
            // <button onClick={this.toggleSignupLogin} style={{ margin: '10px', padding: '10px' }}>
